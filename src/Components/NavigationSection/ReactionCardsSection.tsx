...
const reactionCards = [
  {
    ...
    hoverPosition: { left: "0px", top: "0px" }, // 호버 시 위치
  ...
  },
  {
    ...
    hoverPosition: { left: "345px", top: "0px" }, // 호버 시 위치
    rotation: "rotate-[15deg]",
  ...
  },
  {
    ...
    hoverPosition: { left: "690px", top: "0px" }, // 호버 시 위치
    rotation: "rotate-[-15deg]",
  ...
  },
  {
    ...
    hoverPosition: { left: "1035px", top: "0px" }, // 호버 시 위치
    rotation: "rotate-[15deg]",
    iconPosition: { left: "13.36px", top: "20.52px" },
    cardSize: { width: "w-[345px]", height: "h-[495px]" },
    contentWidth: "w-[285px]"
