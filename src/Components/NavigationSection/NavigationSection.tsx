      ...
      <div className="hidden lg:block self-stretch">
        <div className="self-stretch flex flex-col justify-start items-center gap-12 sm:gap-16 lg:gap-20">
          <div className="self-stretch flex flex-col justify-start items-center gap-8 sm:gap-10 lg:gap-12">
            <div className="w-full max-w-[628px] lg:max-w-none flex flex-col justify-start items-center px-4 sm:px-0">
              <div className="self-stretch flex flex-col justify-start items-center">
                ...
                <div className="self-stretch text-center text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font-['Pretendard'] leading-tight lg:leading-[96px] lg:whitespace-nowrap">
                  다른 크루들의 위즈덤 카드
                </div>
              </div>
